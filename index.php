...
<html lang="en">
  ...
  <body>
    <div class="container-fluid jumbotron col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
        <a href='index.php' ><h1 id="head-text">Composter</h1></a>
        <h2 style="font-family: 'Charmonman', cursive;">"SMART WASTE MANAGER" at your door</h2>
        <div class="buttons">
          <?php
    ...
    <div class="row" style="margin-top:30px;">
      <div class="container-fluid">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center headings"><h1><i class="fa fa-cutlery" aria-hidden="true"></i>&nbsp;SEARCH BY WASTE TYPE</h1></div>
      </div>
    </div>
      ...
      <div class="container-fluid text-center">
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 foot-content">
            <h4>Contact Us:</h4>
            <p><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;help.service@composter.com</p>
        ...
        <div class="row" style="margin-top:20px;">
          <div class="col-lg-12"><p style="color:#b3b3b3;">&copy;2019 CREATED FOR HACKOVATION</p></div>
        </div>
      </div>
    </div>
...
<!--Login Modal ends-->
 ...
 <!-- Include all compiled plugins (below), or include individual files as needed -->
    ...
    <script type="text/javascript" src=js/custom12.js></script>
  </body>
</html>
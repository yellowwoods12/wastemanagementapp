...
<nav class="navbar navbar-default navbar-fixed-top" id="up-nav">
    ...
    <div class="collapse navbar-collapse" id="up_nav">
        ...
        <ul class="nav navbar-nav navbar-right menu_list">
          ...
          <li class="active active_now"><a href="mycart.php?rest_id_url2=<?php echo $_GET['rest_id_url']; ?>"><i class="fa fa-cutlery" aria-hidden="true"></i>&nbsp;My Basket<span class="sr-only">(current)</span></a></li>
        </ul>

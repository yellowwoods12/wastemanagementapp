		...
		while($row = mysqli_fetch_array($exec_city_query))
		{
			...
			<div class='col-lg-8 col-md-8 col-lg-offset-2 col-md-offset-2 result-item' style='height:auto; margin-top:10px;'>
			      ...
			      <div class='col-lg-5 col-md-4' style='height:auto;'>
			        ...
			        <a href='menu.php?rest_id_url=$rest_id'<button class='btn btn-info rest-review'>WASTE ITEMS</button></a>
			        <a href='orders.php?rest_id_url=$rest_id'><button class='btn btn-primary'>BUY WASTE</button></a>
			      </div>
			  </div>
			  </div>  
			";
...
function getOrder()
{
	...
	echo "<div style='width:150px;margin:auto;'><input type='button' class='btn btn-default' value='BUY WASTE'></div>";
	}
}

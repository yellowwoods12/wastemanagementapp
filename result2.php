      ...
      <div class="navbar-header">
              ...
              <div class="logo_heading">
                <a href="index.php" style="float:left;">
                  <div class="navbar-header heading"><h2>Composter</h2></div>
                </a>
              </div>
            </div>
        ...
        <ul class="nav navbar-nav navbar-right menu_list">
          <li class="active active_now"><a href="index.php">Home <span class="sr-only">(current)</span></a></li>
              <li class="dropdown">
               ...
               <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Waste Type<span class="caret"></span></a>
                <ul class="dropdown-menu">
